...
UsuarioController controle = new UsuarioController();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Login do Garçom: ");
    ...
    try {
        ...
        double valor = controle.buscarUsuarioPorLogin(login.getText()).getComissao();
        double total = valor * 0.1;
        JOptionPane.showMessageDialog(this, "Valor da Comissão: " +total +"R$");
    } catch (NegocioException ex) {
        Logger.getLogger(Comissoes.class.getName()).log(Level.SEVERE, null, ex);
        JOptionPane.showMessageDialog(this, "Garçom não encontrado.");
    }
